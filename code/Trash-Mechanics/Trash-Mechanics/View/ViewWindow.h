...
public:
	...
	ViewWindow(const ViewPoint &tl, const int &w = m_DEFAULT_WINWIDTH, const int &h = m_DEFAULT_WINHEIGHT, const std::string &n = m_DEFAULT_WINNAME, const Fl_Color &c = m_DEFAULT_WINCOLOR);
	ViewWindow(const Vec &tl, const int &w = m_DEFAULT_WINWIDTH, const int &h = m_DEFAULT_WINHEIGHT, const std::string &n = m_DEFAULT_WINNAME, const Fl_Color &c = m_DEFAULT_WINCOLOR);
	ViewWindow(const int &x = m_DEFAULT_TOPLEFT.getintX(), const int &y = m_DEFAULT_TOPLEFT.getintY(), const int &w = m_DEFAULT_WINWIDTH, const int &h = m_DEFAULT_WINHEIGHT, const std::string &n = m_DEFAULT_WINNAME, const Fl_Color &c = m_DEFAULT_WINCOLOR);
