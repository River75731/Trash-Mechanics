...
int main(int argc, char *argv[])
{
	...
	world.addRigidBody(Poly(std::vector<Vec>{Vec(300, 250), Vec(300, 300), Vec(500, 300), Vec(500, 250)}), 10, Vec(0, 0), -0.1);
	world.addRigidBody(Poly(std::vector<Vec>{Vec(200, 100), Vec(250, 200), Vec(300, 100)}), 10, Vec(10, 10), 0.2);
	world.addRigidBody(Poly(std::vector<Vec>{Vec(100, 200), Vec(200, 150), Vec(100, 100)}), 10, Vec(10, 10), 0.2);
	world.addRigidBody(Poly(std::vector<Vec>{Vec(200, 200), Vec(200, 220), Vec(230, 320), Vec(250, 240), Vec(250, 210)}), INF, Vec(0, 0), 0.1);
