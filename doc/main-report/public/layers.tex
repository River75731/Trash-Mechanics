...
%block1
\filldraw[fill = yellow, opacity = 0.15, draw opacity = 1](-4.0,-2)rectangle(5,-5.8);
%block2
\filldraw[fill = yellow, opacity = 0.15, draw opacity = 1](-4.0,-6.2)rectangle(5,-10);
...
\draw[arrow](1.5,-6.5)--(1.5,-5.5); %View->ViewModel
